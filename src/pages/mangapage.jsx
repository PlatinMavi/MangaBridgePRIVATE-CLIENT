...
export default function MangaPage(){
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const response = await fetch(`http://16.171.37.129:4000/manga/${params.name}`, {
                    credentials: "include",
        ...
        async function check(Mmanga) {
            try {
                const response = await fetch(`http://16.171.37.129:4000/manga/check/${userInfo.id}&${Mmanga._id}`, {
                    headers: { 'Content-Type': 'application/json' },
                });
        ...
        async function chapterGetter(mangaId) {
            try {
                const response = await fetch(`http://16.171.37.129:4000/chapter/relevant/${mangaId}`, {
                    credentials: "include",
                    headers: { 'Content-Type': 'application/json' },
                });
        ...
        async function CommentsGetter(mangaId) {
            try {
                const response = await fetch(`http://16.171.37.129:4000/manga/comments/${mangaId}`, {
                    headers: { 'Content-Type': 'application/json' },
                });
