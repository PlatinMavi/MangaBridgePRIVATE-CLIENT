...
export default function ProfilePage(){
    ...
    function GetSaved(ui){
      fetch(`http://16.171.37.129:4000/manga/save/getall/${ui.id}`)
                        ...
                        <div className="grid lg:grid-cols-6 md:grid-cols-4 grid-cols-2 mt-4 gap-4">
                          {mangas.length > 0 && mangas.map(manga =>( 
                            <Link to={`/manga/${manga.browser}`}>                                                    
                              <img src={"http://16.171.37.129:4000/Collection/"+manga.image} alt="" className="w-full lg:h-60 md:h-52 h-60 mx-auto rounded-xl shadow-xl" />
