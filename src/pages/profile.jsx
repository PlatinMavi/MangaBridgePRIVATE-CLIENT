...
export default function ProfilePage(){
    ...
    function GetSaved(ui){
      fetch(`https://api.mangabridge.com/manga/save/getall/${ui.id}`)
        ...
        <>
            ...
            <main className="mt-24 container mx-auto  text-white">
                <div className="grid md:grid-cols-12 grid-cols-1 gap-6">
                    ...
                    <div className="md:col-span-9 bg-white my-4 shadow-xl bg-opacity-5 backdrop-blur-sm text-3xl break-words fredoka p-4 rounded-3xl drop-shadow-lg">
                        ...
                        <div className="grid lg:grid-cols-6 md:grid-cols-4 grid-cols-2 mt-4 gap-4">
                          {mangas.length > 0 && mangas.map(manga =>( 
                            <Link to={`/manga/${manga.browser}`}>                                                    
                              <img src={"https://api.mangabridge.com/Collection/"+manga.image} alt="" className="w-full lg:h-60 md:h-52 h-60 mx-auto rounded-xl shadow-xl" />
