...
export default function MangaAdd(){
    ...
    useEffect(() =>{
      fetch('https://api.mangabridge.com/profile', {
        credentials: 'include',
    ...
    const fetchMangaList = async () => {
        try {
          const response = await fetch("https://api.mangabridge.com/manga/all"); // Adjust the endpoint URL to your manga fetch route
          if (response.ok) {
    ...
    async function submitManga(ev){
        ev.preventDefault()
        const response = await fetch("https://api.mangabridge.com/manga/add",{ 
            method:"POST",
    ...
    async function submitChapter(ev){
        ev.preventDefault()
        const response = await fetch("https://api.mangabridge.com/chapter/add",{ 
            method:"POST",
