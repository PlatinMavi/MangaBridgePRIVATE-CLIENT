...
export default function MangaAdd(){
    ...
    useEffect(() =>{
      fetch('http://16.171.37.129:4000/profile', {
        credentials: 'include',
    ...
    const fetchMangaList = async () => {
        try {
          const response = await fetch("http://16.171.37.129:4000/manga/all"); // Adjust the endpoint URL to your manga fetch route
          if (response.ok) {
    ...
    async function submitManga(ev){
        ev.preventDefault()
        const response = await fetch("http://16.171.37.129:4000/manga/add",{ 
            method:"POST",
    ...
    async function submitChapter(ev){
        ev.preventDefault()
        const response = await fetch("http://16.171.37.129:4000/chapter/add",{ 
            method:"POST",
